...
<div id="wrapper">
           <header>
            ...
            <h2 class="welcome">Welcome <?php echo $this->session->userdata('admin_first');?></h2>
    ...
    <div class="logout">
                <a href="<?php echo base_url('login/admin_logout')?>" class="btn logoutbtn">Click me to Logout</a>
     </div>
		<!-- Navigation -->
                <nav>
